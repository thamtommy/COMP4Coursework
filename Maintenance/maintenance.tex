...
The user will be able to add/delete and update bookings. The user can find these options through "Bookings" on the menu bar or click on the 'Manage Bookings' QPushButton at the bottom of the main screen however, the update booking option can only be accessed from the menu bar.  \\
...
\subsection{Creating a module for each feature}
\begin{figure}[H]
    \pythonfile[firstline=5,lastline=24]{./Implementation/GUI/main_window.py}
\end{figure}
...
\begin{figure}[H]
    \pythonfile[firstline=28,lastline=31]{./Implementation/GUI/add_item_to_order.py}
\end{figure}
...
\begin{figure}[H]
    \pythonfile[firstline=133,lastline=146]{./Implementation/GUI/manage_order.py}
\end{figure}
...
\begin{figure}[H]
    \pythonfile[firstline=45,lastline=48]{./Implementation/GUI/manage_order.py}
\end{figure}
...
\subsection{Part of invoice}

\pythonfile[firstline=100, lastline = 111]{./Implementation/GUI/print_invoice.py}
...
\pythonfile[firstline=59, lastline = 61]{./Implementation/GUI/print_invoice.py}
...
\pythonfile[firstline=66, lastline = 68]{./Implementation/GUI/print_invoice.py}
