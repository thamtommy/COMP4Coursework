...
\begin{figure}[H]
    \includegraphics[width = 15cm]{./Manual/images/install1} 
...
\begin{tabular}{|p{8cm}|p{2cm}|p{2cm}|}
 ...
 How do I add an item to the menu? & 5.3.4 & \pageref{fig:additem1}\\ \hline
How do I delete an item off the menu? & 5.3.5 & \pageref{fig:deleteitem1} \\ \hline
 How do I update an item's price?& 5.3.6 & \pageref{fig:updateitem1} \\ \hline
 How do I add a booking? & 5.3.7 & \pageref{fig:addbooking1} \\ \hline
 How do I delete a booking? & 5.3.8 &  \pageref{fig:deletebooking1}\\ \hline
 How do I update a booking? & 5.3.9 & \pageref{fig:updatebooking1} \\ \hline
How do I manage an order for a table & 5.3.10 & \pageref{fig:assignex1} \\ \hline
 A customer has come in without booking advance, how do I assign him to a table? & 5.3.11 & \pageref{fig:assigncust1} \\ \hline
How do I add an item to the order? & 5.3.12& \pageref{fig:additemorder1} \\ \hline
 How do I delete an item off the order? & 5.3.13 & \pageref{fig:deleteitemorder1} \\ \hline
 How do I print an invoice? & 5.3.14& \pageref{fig:printinvoice1} \\ 
...
5. The booking should delete if the user entered a valid Booking ID - you can check by looking at the table where it will be removed if successful.
...
6. You will see the new updated information for the booking from the table shown above the fields.
...
4. The manage order box will come up with the details of the booking that the customer you selected made.
...
6. The assign customer box should close and the manage order box should appear with the booking details.
...
7. The item you added will now appear on the manage order box.
...
\begin{figure}[H]
    \includegraphics[height = 9cm]{./Manual/images/base/ManageOrder} 
    \caption{} \label{fig:deleteitemorder1}
\end{figure}
...
3. The delete item off order will pop up.
